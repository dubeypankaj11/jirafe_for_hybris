...
import com.jirafe.constants.JirafereportcockpitConstants;


/**
 * This is the extension manager of the jirafereportcockpit extension.
 */
public class JirafereportcockpitManager extends GeneratedJirafereportcockpitManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	@SuppressWarnings("unused")
	private final static Logger LOG = Logger.getLogger(JirafereportcockpitManager.class.getName());
	 ...
	 */
	public static final JirafereportcockpitManager getInstance()
	{
		return (JirafereportcockpitManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				JirafereportcockpitConstants.EXTENSIONNAME);
	}
