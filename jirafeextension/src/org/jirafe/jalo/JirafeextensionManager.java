...
/**
 * This is the extension manager of the Jirafeextension extension.
 */
public class JirafeextensionManager extends GeneratedJirafeextensionManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(JirafeextensionManager.class.getName());
	 ...
	 */
	public static JirafeextensionManager getInstance()
	{
		return (JirafeextensionManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				JirafeextensionConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public JirafeextensionManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of JirafeextensionManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of JirafeextensionManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of JirafeextensionManager called, current tenant: " + getTenant().getTenantID());
		}
	}
