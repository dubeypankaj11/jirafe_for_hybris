...
/**
 * Provides necessary meta information about the jirafeextension hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class JirafeextensionHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(JirafeextensionHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "org.jirafe.hmc.locales";
